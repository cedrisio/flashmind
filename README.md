...
```sh
grep -RniE "cognitive training|brain training|wellness|exercise|improve your|mental fitness|N-back|localStorage|sessionStorage" README.md index.html src || true
```
